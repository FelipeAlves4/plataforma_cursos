...
type Props = { courses: Course[]; recommendedCourses: Course[]; continueLearning?: { lessonId: number; lessonTitle: string; moduleTitle: string; courseTitle: string; courseSlug: string; thumbnailPath?: string | null; progress: number } | null; };
